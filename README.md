...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-6%2C761%20rows-8250df">
...
**Public extract:** 6,761 rows · **Live catalog:** 6,758 domains
...
- `email.csv` — public CSV extract (6,761 rows)
- `email.json` — public JSON extract (6,761 rows)
...
| ----------------------- | ------------------------------------------------ |
| 6,761-row public sample | 6,758 live domains                               |
...
> Unique Domains. *Available .EMAIL One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
